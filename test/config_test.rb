...
class ConfigTest < MiniTest::Unit::TestCase
  ...
  def test_guid_value_source
    config = Value::Config.new do
      application 'value.exercise.bfelob' do
        value_source 'guid-value-source' do
          klass "GuidValueSource"
          value 'guid-value'
          specification 'test'
          params :a => 'a', :b => 'b'
        end
    ...
    assert_equal 'guid-value', config.applications['value.exercise.bfelob'].values['guid-value-source'].process
  end
